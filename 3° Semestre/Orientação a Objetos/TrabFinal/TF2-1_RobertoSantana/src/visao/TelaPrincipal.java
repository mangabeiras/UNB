...
public class TelaPrincipal extends JFrame {
	...
	// CONSTRUTOR
	public TelaPrincipal(Grupo grupo){
		configuraFrame();
		criaBotoesCadastro();
	...
	private void addEscutadores(Grupo grupo) {
		...
		novo.addItemListener(evt -> defineCadastro(evt, grupo));		
	}
